...
public class SwaggerConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Породия на вкусочка")
                .version("1.0.0")
                .description("Если что то не работает напиши мне и пришли логи.\n Все методы удаление и изменения доступны только пользователю ,который их создал. \nЛогин админа:root\nПороль:root")
